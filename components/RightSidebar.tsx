...
const RightSidebar = () => {
    return (
        <div className='flex flex-col justify-start items-center w-[421px] h-[135vh]  bg-[#FCFCFC] font-poppins stick right-0 top-0 border-t border-l border-[#E7E7E7] pl-[49px] pr-[12px]'>
